...
const Footer = () => {
  return (
    <footer
      className="bg-gradient-to-b from-[#13181F] to-[#0c1015] text-white py-16 px-6 md:px-20 bg-cover bg-center bg-no-repeat relative overflow-hidden"
      style={{
        backgroundImage:
    ...
    >
      {/* Decorative Elements */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#cae28e] via-[#a7cb50] to-[#cae28e]"></div>
      <div className="absolute -top-24 -right-24 w-48 h-48 rounded-full bg-[#cae28e]/10 blur-3xl"></div>
      <div className="absolute -bottom-32 -left-32 w-64 h-64 rounded-full bg-[#cae28e]/10 blur-3xl"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-16 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center text-gray-300 hover:text-[#cae28e] transition-colors hover-pulse">
                <FaMapMarkerAlt className="mr-3 text-[#cae28e]" />
                <span>123 Solar Street, Green City, 12345</span>
              </div>
              <div className="flex items-center text-gray-300 hover:text-[#cae28e] transition-colors hover-pulse">
                <FaPhoneAlt className="mr-3 text-[#cae28e]" />
                <span>+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center text-gray-300 hover:text-[#cae28e] transition-colors hover-pulse">
                <FaEnvelope className="mr-3 text-[#cae28e]" />
            ...
            {footerSections.slice(0, 2).map((section) => (
              <div key={section.title}>
                <h3 className="text-lg font-semibold mb-4 relative inline-block">
                  ...
                  <span className="absolute -bottom-1 left-0 w-1/2 h-1 bg-[#cae28e]"></span>
                </h3>
                <ul className="space-y-3 text-gray-300">
                  {section.links.map((link) => (
                    <li key={link.name}>
                      <Link
                        to={link.path}
                        className="hover:text-[#cae28e] transition-colors flex items-center group hover-pulse"
                      >
                        <span className="w-0 h-0.5 bg-[#cae28e] mr-0 group-hover:w-2 group-hover:mr-2 transition-all duration-300"></span>
                        {link.name}
                      </Link>
                    </li>
                  ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16 pb-16 border-b border-white/10">
          <div>
            <h3 className="text-xl font-semibold mb-4 relative inline-block">
              ...
              <span className="absolute -bottom-1 left-0 w-1/3 h-1 bg-[#cae28e]"></span>
            </h3>
            <p className="text-gray-300 mb-6 max-w-md">
          ...
          <div>
            <form className="flex flex-col sm:flex-row gap-3">
              <input 
                ...
                className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 flex-grow focus:outline-none focus:ring-2 focus:ring-[#cae28e] focus:border-transparent transition-all"
                required
              />
              <button 
                type="submit" 
                className="group relative overflow-hidden bg-[#cae28e] text-black font-medium px-6 py-3 rounded-lg transition-all duration-300 flex items-center justify-center border-2 border-transparent hover:border-[#cae28e] hover-glow"
              >
