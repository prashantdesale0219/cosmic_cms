    ...
    <div className="font-sans text-gray-700 bg-gray-50">
      ...
      <section className="relative h-64 md:h-80 lg:h-96">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
          ...
          <div className="mt-6 md:mt-8">
            <button className="bg-yellow-green-400 hover:bg-yellow-green-500 text-yellow-green-950 px-6 py-3 rounded-full font-medium transition-all duration-300 transform hover:scale-105 shadow-lg">Explore Now</button>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-screen-xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <span className="bg-yellow-green-100 text-yellow-green-800 text-sm font-medium px-4 py-1.5 rounded-full mb-4 inline-block">Our Portfolio</span>
            ...
            projectData.map((project, idx) => (
              <div key={project._id || idx} className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                <div className="relative overflow-hidden">
                  <div className="absolute top-4 right-4 z-10 bg-yellow-green-400 text-yellow-green-950 text-xs font-medium px-2.5 py-1 rounded-full">
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Link to={`/projects/${project._id || idx}`} className="text-yellow-green-600 hover:text-yellow-green-800 font-medium flex items-center gap-1 text-sm">
            ...
            fallbackProjectImages.map((src, idx) => (
              <div key={idx} className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#13181f]/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                  <button className="bg-yellow-green-400 hover:bg-yellow-green-500 text-yellow-green-950 px-4 py-2 rounded-full text-sm font-medium shadow-lg transition-all duration-300">View Details</button>
                </div>
              </div>
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-yellow-green-600 hover:text-yellow-green-700 cursor-pointer text-sm font-medium flex items-center">
        ...
        <div className="text-center mt-12">
          <button className="border-2 border-yellow-green-400 text-yellow-green-600 hover:bg-yellow-green-400 hover:text-yellow-green-950 px-6 py-3 rounded-full font-medium transition-colors duration-300 shadow-md">View All Projects</button>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-16">
            <span className="bg-yellow-green-100 text-yellow-green-800 text-sm font-medium px-4 py-1.5 rounded-full mb-4 inline-block">Our Process</span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step, idx) => (
              <div key={idx} className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="bg-yellow-green-100 w-14 h-14 rounded-full flex items-center justify-center mb-4 text-yellow-green-600 text-xl">
                  {step.icon}
                </div>
                <div className="flex items-center mb-3">
                  <span className="bg-yellow-green-400 text-yellow-green-950 text-xs font-medium rounded-full w-6 h-6 flex items-center justify-center mr-2">{idx + 1}</span>
          ...
          <div className="mt-12 text-center">
            <button className="bg-yellow-green-400 hover:bg-yellow-green-500 text-yellow-green-950 px-6 py-3 rounded-full font-medium transition-colors duration-300 shadow-md">Learn More About Our Process</button>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-r from-[#13181f] to-[#1c280b] rounded-2xl overflow-hidden shadow-xl">
            <div className="md:flex items-center">
              <div className="md:w-1/2 p-8 md:p-12">
                <span className="bg-yellow-green-800/50 text-yellow-green-300 text-sm font-medium px-4 py-1.5 rounded-full mb-4 inline-block">Get Started</span>
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Start Your Solar Journey?</h2>
                <p className="text-yellow-green-100 mb-8">Contact us today for a free consultation and quote. Our team of experts is ready to help you transition to clean, renewable energy.</p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="bg-yellow-green-400 hover:bg-yellow-green-500 text-yellow-green-950 px-6 py-3 rounded-full font-medium transition-colors duration-300 flex items-center shadow-lg">
                    <FiPhone className="mr-2" /> Call Us
                  </button>
                  <button className="bg-white text-[#13181f] hover:bg-yellow-green-50 px-6 py-3 rounded-full font-medium transition-colors duration-300 flex items-center shadow-lg">
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-xl border border-gray-100">
            <div className="md:flex">
              <div className="md:w-1/2 p-8 md:p-12">
                <span className="bg-yellow-green-100 text-yellow-green-800 text-sm font-medium px-4 py-1.5 rounded-full mb-4 inline-block">Free Estimate</span>
                ...
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" id="first-name" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-green-400 focus:border-yellow-green-400 transition-colors duration-300" />
                    </div>
                    <div>
                      <label htmlFor="last-name" className="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                      <input type="text" id="last-name" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-green-400 focus:border-yellow-green-400 transition-colors duration-300" />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="email" id="email" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-green-400 focus:border-yellow-green-400 transition-colors duration-300" />
                    </div>
                    <div>
                      <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
                      <input type="tel" id="phone" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-green-400 focus:border-yellow-green-400 transition-colors duration-300" />
                    </div>
                  </div>
                  
                  <div>
                    <label htmlFor="address" className="block text-sm font-medium text-gray-700 mb-1">Property Address</label>
                    <input type="text" id="address" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-green-400 focus:border-yellow-green-400 transition-colors duration-300" />
                  </div>
                  
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-gray-700 mb-1">Additional Information</label>
                    <textarea id="message" rows="4" className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-yellow-green-400 focus:border-yellow-green-400 transition-colors duration-300"></textarea>
                  </div>
                  
                  <div className="flex items-center">
                    <input id="terms" type="checkbox" className="h-4 w-4 text-yellow-green-600 focus:ring-yellow-green-400 border-gray-300 rounded" />
                    <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">I agree to the terms and privacy policy</label>
                  </div>
                  
                  <button type="submit" className="w-full bg-yellow-green-400 hover:bg-yellow-green-500 text-yellow-green-950 px-6 py-3 rounded-full font-medium transition-colors duration-300 shadow-md">Submit Request</button>
                </form>
              </div>
                ...
                <div className="h-full flex flex-col justify-between">
                  <div>
                    ...
                    <ul className="space-y-4">
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-6 w-6 text-yellow-green-300">
                          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                          </svg>
                        </div>
                        <p className="ml-3 text-base text-yellow-green-100">High-quality solar panels with 25+ years warranty</p>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-6 w-6 text-yellow-green-300">
                          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p className="ml-3 text-base text-yellow-green-100">Professional installation by certified technicians</p>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-6 w-6 text-yellow-green-300">
                          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p className="ml-3 text-base text-yellow-green-100">Customized solutions for residential and commercial properties</p>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-6 w-6 text-yellow-green-300">
                          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p className="ml-3 text-base text-yellow-green-100">Financing options and assistance with incentives</p>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-6 w-6 text-yellow-green-300">
                          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p className="ml-3 text-base text-yellow-green-100">Ongoing maintenance and support services</p>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="mt-8 pt-8 border-t border-[#1c280b]">
                    ...
                    <div className="space-y-3">
                      <a href="tel:+11234567890" className="flex items-center text-yellow-green-300 hover:text-yellow-green-100 transition-colors duration-300">
                        <FiPhone className="mr-3" /> (123) 456-7890
                      </a>
                      <a href="mailto:info@example.com" className="flex items-center text-yellow-green-300 hover:text-yellow-green-100 transition-colors duration-300">
                        <FiMail className="mr-3" /> info@example.com
                      </a>
                      <div className="flex items-center text-yellow-green-300">
      ...
      {/* ───────────── Gallery Section ───────────── */}
      <section className="py-16 bg-yellow-green-50">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="text-center mb-12">
            <span className="bg-yellow-green-100 text-yellow-green-800 text-sm font-medium px-4 py-1.5 rounded-full mb-4 inline-block">Gallery</span>
              ...
              galleryData.map((item, idx) => (
                <div key={idx} className="group relative overflow-hidden rounded-lg h-48 md:h-64 shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#13181f]/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                    ...
                    <Link to={`/projects/${item._id || idx}`} className="mt-2 bg-yellow-green-400 hover:bg-yellow-green-500 text-yellow-green-950 px-3 py-1.5 rounded-full text-xs font-medium shadow-lg transition-all duration-300 w-max">View Details</Link>
                  </div>
                </div>
              ))
            ) : (
              ...
              galleryImages.map((image, idx) => (
                <div key={idx} className="group relative overflow-hidden rounded-lg h-48 md:h-64 shadow-md hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#13181f]/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                    ...
                    <Link to={`/projects/${idx}`} className="mt-2 bg-yellow-green-400 hover:bg-yellow-green-500 text-yellow-green-950 px-3 py-1.5 rounded-full text-xs font-medium shadow-lg transition-all duration-300 w-max">View Details</Link>
                  </div>
                </div>
              ))
            )}
          ...
          <div className="mt-12 text-center bg-white p-8 rounded-xl shadow-md border border-gray-100">
            <div className="mb-8">
              <span className="text-yellow-green-600 font-medium mb-2 block">Explore More</span>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button className="bg-yellow-green-400 hover:bg-yellow-green-500 text-yellow-green-950 px-6 py-3 rounded-full font-medium transition-colors duration-300 shadow-md">Schedule a Tour</button>
              <button className="border-2 border-yellow-green-400 text-yellow-green-600 hover:bg-yellow-green-400 hover:text-yellow-green-950 px-6 py-3 rounded-full font-medium transition-colors duration-300 shadow-md">View Portfolio</button>
            </div>
          </div>
        </div>
      </section>
