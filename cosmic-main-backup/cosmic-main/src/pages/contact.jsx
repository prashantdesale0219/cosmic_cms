      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <div className="flex items-center justify-center space-x-2 text-sm">
            ...
            <span>—</span>
            <span className="text-[#cae28e]">Contact</span>
          </div>
        </div>
      </div>
      
      {/* Contact Section */}
      <section className="w-full bg-[#eef7f3] py-16 flex justify-center">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-8 justify-center">
          ...
          <div className="w-full lg:w-5/12 order-first lg:order-last">
            <div
              className="rounded-lg p-6 md:p-10 shadow-lg relative overflow-hidden"
              style={{
                background: "linear-gradient(180deg, #cae28e 0%, #a7cb50 100%)",
              }}
            >
              {/* Background Image */}
              <div 
              ...
              <div className="relative z-10">
                <p className="text-center text-xs tracking-widest mb-2 text-[#207F54]">
                  —☘ ASK US ☘—
                </p>

                <h2 className="font-extrabold text-3xl md:text-4xl mb-6 md:mb-8 leading-tight text-center text-[#0E3F2A]">
                ...
                {submitStatus === 'success' ? (
                  ...
                  <div className="flex flex-wrap gap-3 justify-center mb-2">
                    {["residential","housing_society","commercial"].map((type) => (
                      <label key={type} className="relative cursor-pointer">
                        ...
                        />
                        <div className="px-6 py-2 rounded-full bg-white/50 text-[#0E3F2A] peer-checked:bg-[#0E3F2A] peer-checked:text-white transition-all hover:bg-white/70">
                  ...
                  {selectedType === "residential" && (
                    <>
                      <div className="space-y-1">
                        <label className="text-xs font-medium text-[#0E3F2A]">Full Name <span className="text-red-500">*</span></label>
                        <input 
                          type="text" 
                          name="fullName"
                          ...
                          required 
                          className="w-full rounded-lg px-5 py-3 bg-white/70 text-[#0E3F2A] text-sm focus:outline-none focus:ring-2 focus:ring-[#0E3F2A] border border-white/30"
                        />
                      </div>
                      <div className="flex flex-col md:flex-row gap-4">
                        <div className="flex-1 space-y-1">
                          <label className="text-xs font-medium text-[#0E3F2A]">City <span className="text-red-500">*</span></label>
                          <input 
                            type="text" 
                            name="city"
                            value={formData.city}
                        ...
                        <div className="flex-1 space-y-1">
                          <label className="text-xs font-medium text-[#0E3F2A]">Pin code</label>
                          <input 
                            type="text" 
                            name="pincode"
                      ...
                      <div className="space-y-1">
                        <label className="text-xs font-medium text-[#0E3F2A]">WhatsApp number <span className="text-red-500">*</span></label>
                        <input 
                          type="tel" 
                          name="whatsapp"
                      ...
                      <div className="space-y-1">
                        <label className="text-xs font-medium text-[#0E3F2A]">Email Address</label>
                        <input 
                          type="email" 
                          name="email"
                      ...
                      <div className="space-y-1">
                        <label className="text-xs font-medium text-[#0E3F2A]">Message</label>
                        <textarea 
                          name="message"
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <input 
                      ...
                      onChange={handleInputChange}
                      className="w-4 h-4 accent-[#0E3F2A]" 
                      required 
                    />
                    <label htmlFor="terms" className="text-xs text-[#0E3F2A]">
                      I agree to Cosmic Powertech's <a href="#" className="text-[#207F54] hover:underline">terms</a> & <a href="#" className="text-[#207F54] hover:underline">privacy</a>
                    </label>
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`mt-2 inline-flex items-center gap-2 self-start rounded-full bg-[#0E3F2A] text-white px-6 py-3 font-semibold hover:bg-[#207F54] transition-all shadow-md hover:shadow-[#0E3F2A]/20 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                  >
